...
(async function example() {
  ...
  await driver.findElement(By.name("password")).sendKeys(process.env.VUE_APP_VERIFIED_PASSWORD, Key.RETURN);
  await driver
    ...
    .then(function() {
      ...
      driver.getTitle().then(function(title) {
        setTimeout(function() {
          ...
          driver.findElement(By.name("search_submit")).click().then(function() {
              setTimeout(function() {
                driver.findElement(By.name('learn_more')).click();
              }, 5000)
          })
          driver.findElement(By.name('learn_more')).click();
          console.log(title);
